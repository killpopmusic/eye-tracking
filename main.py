...
def main():
    ...
    parser.add_argument('--num_persons', type=int, default=10, help='Number of persons to use for training/evaluation.')
    ...
    if args.mode == 'train':
        ...
        train_loader, val_loader, input_features = get_h5_data_loaders(data_path=args.data_path, batch_size=args.batch_size, num_persons=args.num_persons)
        ...
        _, val_loader, _ = get_h5_data_loaders(data_path=args.data_path, batch_size=args.batch_size, num_persons=args.num_persons)
